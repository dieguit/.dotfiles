...
module RbConfig
  RUBY_VERSION.start_with?("2.3.") or
    raise "ruby lib version (2.3.7) doesn't match executable version (#{RUBY_VERSION})"

  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.3.0/x86_64-darwin17")
  ...
  CONFIG["MINOR"] = "3"
  CONFIG["TEENY"] = "0"
  CONFIG["PATCHLEVEL"] = "456"
  CONFIG["INSTALL"] = '/usr/local/opt/coreutils/bin/ginstall -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/dieguit/.rvm/rubies/ruby-2.3.7")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/dieguit/.rvm/rubies/ruby-2.3.7' '' '--with-opt-dir=/usr/local/opt/libyaml:/usr/local/opt/readline:/usr/local/opt/libksba:/usr/local/opt/openssl' '--disable-install-doc' '--enable-shared' 'build_alias=' 'host_alias=' 'target_alias=' 'CC=gcc'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/dieguit/.rvm/rubies/ruby-2.3.7"
  ...
  CONFIG["RUBY_PROGRAM_VERSION"] = "2.3.7"
